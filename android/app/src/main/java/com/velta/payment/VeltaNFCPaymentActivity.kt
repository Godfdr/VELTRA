...
class VeltaNFCPaymentActivity : AppCompatActivity(), NfcAdapter.ReaderCallback {
    ...
    companion object {
        private const val TAG = "VeltaNFCPayment"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_velta_nfc_payment)
        ...
        Log.d(TAG, "VELTA NFC Payment Activity initialized")
    }
    ...
    private fun initializeBiometric() {
        ...
        val callback = object : BiometricPrompt.AuthenticationCallback() {
            ...
            override fun onAuthenticationError(errorCode: Int, errString: CharSequence) {
                ...
                Toast.makeText(this@VeltaNFCPaymentActivity, "Auth Error: $errString", Toast.LENGTH_SHORT).show()
            }

            override fun onAuthenticationFailed() {
                super.onAuthenticationFailed()
                Log.w(TAG, "Biometric authentication failed")
                Toast.makeText(this@VeltaNFCPaymentActivity, "Authentication failed", Toast.LENGTH_SHORT).show()
            }
        }
    ...
    private fun processNDEF(tag: Tag, tagUID: String) {
        ...
        ndef?.let {
            Log.d(TAG, "NDEF Tag detected with ${it.cachedhNdefMessage?.records?.size ?: 0} records")
    ...
    private class EncryptionManager {
        ...
        private val masterKey = MasterKey.Builder(this.application())
...
private val EncryptionManager.application: Context
    get() = error("Get app context from activity")
